    ...
    <Row gutter={[16, 16]}>
      <Col xs={24} sm={24} md={24} lg={24}>
        <div>
          ...
          <p className='text-gray-500 text-lg mb-6'>Let's uncover your career journey, tell us about your most recent job</p>
        </div>
      </Col>
      ...
      {work_histories.length && <Col xs={24} sm={24} md={24} lg={24}>
